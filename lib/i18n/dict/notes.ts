...
const en = {
  ...
  // The visualizer (the highlight toolkit's chart tool, notepad surfaces)
  vizAction: "Visualize",
  vizTitle: "Visualize this passage",
  vizAskLead: "What should the visual show? Pick a lens, add anything specific, or both.",
  vizFormTrend: "Trend over time",
  vizFormCompare: "Compare quantities",
  vizFormSequence: "Sequence of events",
  vizFormMechanism: "Map the mechanism",
  vizAskPlaceholder: "Anything specific — “compare the three eras’ margins”, “who pays whom”…",
  vizContextNote:
    "The desk reads the passage against this notepad and the rest of your record, and draws only what the record itself supports — an honest “can’t” beats an invented chart.",
  vizGenerate: "Generate",
  vizBusy: "Reading the record…",
  vizInsufficientTitle: "The record can’t support that visual yet",
  vizKeep: "Keep on this notepad",
  vizKept: "Kept ✓",
  vizBack: "Ask differently",
  vizDiscard: "Discard",
  vizFailed: "Visualization failed — try again.",
  vizSourcePrefix: "From the record:",
  vizCaveatPrefix: "Caveat:",
  vizDelete: "Remove visual",
  vizDeleteConfirm: "Remove this visual? The notepad’s text is untouched.",
  ...
  annSurfThesisGeneric: "Signal thesis",
  annSurfBackstory: "“{name}” — deep history",
  annSurfBackstoryGeneric: "Signal deep history",
...
const zh: Record<keyof typeof en, string> = {
  ...
  vizAction: "可视化",
  vizTitle: "可视化这段文字",
  vizAskLead: "想看到什么样的图？选一个视角，或写下具体想看的内容，也可以两者都要。",
  vizFormTrend: "随时间的趋势",
  vizFormCompare: "数量对比",
  vizFormSequence: "事件时间线",
  vizFormMechanism: "机制关系图",
  vizAskPlaceholder: "具体想看什么——例如“对比三个时期的利润率”“谁付钱给谁”……",
  vizContextNote:
    "工作台会结合这本记事本和你的整个研究档案来解读这段文字，只画档案本身支持的内容——诚实的“画不了”胜过编造的图。",
  vizGenerate: "生成",
  vizBusy: "正在阅读档案……",
  vizInsufficientTitle: "档案还不足以支持这张图",
  vizKeep: "保留在这本记事本",
  vizKept: "已保留 ✓",
  vizBack: "换个问法",
  vizDiscard: "放弃",
  vizFailed: "生成失败——请重试。",
  vizSourcePrefix: "出自档案：",
  vizCaveatPrefix: "注意：",
  vizDelete: "移除图表",
  vizDeleteConfirm: "移除这张图？记事本的文字不受影响。",
  ...
  annSurfThesisGeneric: "信号论点",
  annSurfBackstory: "“{name}”——深度历史",
  annSurfBackstoryGeneric: "信号深度历史",
  annSurfChat: "分析师回复",

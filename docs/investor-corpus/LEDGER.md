...
| `templeton-letter-the-templeton-letters-keeping-a-client-happy-par` | [Templeton letters post: The Templeton Letters: Keeping a Client Happy, Part 4](https://web.archive.org/web/20191207125622/https://sirjohntempleton.org/2010/05/26/the-templeton-letters-keeping-a-client-happy-part-iv/) | BLOCKED | 2026-08-13 |  scripts/corpus/lib.ts's dynamic hub-expansion slugify() truncates this title and "...Part 3" to an identical 64-char slug (no uniqueness check on that code path, unlike the static catalog parser); Part 3's later fetch overwrote this Part 4 file on disk — content unrecoverable under this slug this session; see the Part 3 row (verified) for what survived  |
